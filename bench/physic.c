...
double semf(double a, double b){
    ...
    c =((15.67 * a - pow(a,((3.0)/(2.0))) * 17.23) - ((0.75 * pow(b,2.0))/(cbrt(pow((pow((exp((1.0)/(3.0))),(log(a)))),3.0))) + 93.2 * (a * 1.0 - 4.0 * b))) - ((93.2 * pow(b,(2.0 * 1.0)))/(a) * pow((pow((-2.0),2.0)),(pow(1.0,2.0))) - (a5)/(pow(b,0.5)));
